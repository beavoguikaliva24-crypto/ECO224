...
from .models import (
    TableAnnee, TableNiveau, TableOption, TableRole, 
    TablePermission, TableUtilisateur, TableEleve, 
    TableClasse, TableFraisScolarite, TableAffectation, TableRecouvrement
)
